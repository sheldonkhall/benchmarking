...
# execute validation
java -cp $LDBC_DRIVER:$WORKSPACE/$LDBC_CONNECTOR com.ldbc.driver.Client -db ai.grakn.GraknDb -P $LDBC_VALIDATION_CONFIG -vdb $WORKSPACE/generate-SNB/$CSV_DATA/validation_params.csv -rd $WORKSPACE/results
